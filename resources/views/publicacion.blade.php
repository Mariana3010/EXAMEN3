				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<center><img src="{{$publicacion->imagen}}"></span></center>
							<?php
...
<?php foreach($arregloDividido as $key=>$value): ?>
	...
	<?php
							...
							$arreglo  = $publicacion->contenido2;
$arregloDividido2 = explode("ESTOESUNENTER", $arreglo);
?>

<?php foreach($arregloDividido2 as $key=>$value): ?>
	<p>{{$arregloDividido2[$key]}}</p>
